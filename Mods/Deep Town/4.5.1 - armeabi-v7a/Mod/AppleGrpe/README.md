...
# Changelog:
Mod | Modified Dictionary/XML(s) | Modified File(s) ~~In assets/json/~~
--- | ----------------------- | ---------------------------------
...
Buildings can be purchased with any panel level. | `"unlockSegment":0`<br>`"unlockSegment":"0"` | `building_blueprints.json`