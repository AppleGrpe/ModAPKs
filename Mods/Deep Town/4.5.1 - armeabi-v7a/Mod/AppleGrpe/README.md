...
4. Compile. ( or compress the folders and files and rename the .zip extension to .apk )
5. Sign the .apk ( you can also not )
6. Install ( simple )
What I Did:
1, 3, 6.
2. ZArchiver ( you already know that if you read the above. )
3. Used Acode
4. Instead of compressing, used apk editor ( On the play store is no longer available, install the apk. ) to replace json/ with what the modded json/ folder. And Build
5. apk editor signs automatically
6. yes.
Changelog ( syntax: editedElement editedFile ):
